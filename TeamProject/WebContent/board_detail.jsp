                     ...
                     <table class="table freeboard" style="background-color: #FFFFFF;">						
						...
						<tbody>
							<tr>
								...
								<td><a href="board_detail.html">공지글입니다.</a><span class="badge badge-danger mx-2">공지</span></td>
							...
							<tr>
								...
								<td><a href="board_detail.html">오늘 등록된 글에는 NEW 뱃지를 드려요.</a><span class="badge badge-primary mx-2">NEW</span></td>
								<td class="text-center">Otto</td>
							...
							<tr>
								...
								<td><a href="board_detail.html">대구 대왕 닭칼국수 다 먹으면 100만원 준다고 합니다!!</a></td>
							...
							<tr>
								...
								<td><a href="board_detail.html">연매출 7억, 직접 짠 들기름을 발라 구운 옥돌 김 구이</a></td>
							...
							<tr>
								...
								<td><a href="board_detail.html">평양냉면 뽀개기 62곳 정리</a></td>
								<td class="text-center">Otto</td>
							...
							<tr>
								...
								<td><a href="board_detail.html">아주 긴 텍스트입니다 아주 긴 텍스트입니다 아주 긴 텍스트입니다 아주 긴 텍스트.. </a></td>
								<td class="text-center">Thornton</td>
