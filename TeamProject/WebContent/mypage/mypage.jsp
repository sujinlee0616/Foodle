...
<body >
	...
	<div class="sidenav" id="floatMenu" style="position:absolute; top: 40%;box-sizing: content-box; z-index:10;background-color: #fff; height:300px; width:220px">		
		...
		<div class="container py-5">
			...
			<div class="row">
				<div class="col-md-2 col-sm-6 col-xs-6 category-responsive">
					<span id="mypage_wish" class="category-wrap">
						<div class="category-block">
							<svg class="category-img" id="Capa_1"
								xmlns="http://www.w3.org/2000/svg"
								xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px"
								y="0px" viewBox="-50 -80 600 600" xml:space="preserve">
                                <g>
                                    <path
					...
					<span id="mypage_recent" class="category-wrap">
						<div class="category-block">
							<svg class="category-img" id="Capa_2"
								...
								version="1.1" x="0px" y="0px" viewBox="140 0 720 900"
								xml:space="preserve">
                                <g>
                                    <path
									d="M953.8,487.2l-4.4-4.4C888.7,422.2,818,375.2,739.1,343.2C663,312.3,582.5,296.7,500,296.7c-82.5,0-163,15.7-239.1,46.5   c-78.8,32-149.6,78.9-210.2,139.6l-4.4,4.4c-7.1,7.1-7.1,18.6,0,25.8l4.4,4.4C111.3,578.1,182,625,260.9,657   c76.1,30.9,156.6,46.5,239.1,46.5c82.5,0,163-15.7,239.1-46.5c78.8-32,149.6-78.9,210.2-139.6l4.4-4.4   C960.9,505.9,960.9,494.4,953.8,487.2z M274.5,623.3C204,594.6,140.2,553.2,85,500.1C140.2,447,204,405.6,274.5,377   c44.4-18,90.3-30.5,137.3-37.4c-56.6,31.2-95.1,91.5-95.1,160.6s38.5,129.4,95.1,160.6C364.9,653.8,318.9,641.3,274.5,623.3z    M353.2,500.1c0-80.9,65.8-146.8,146.8-146.8s146.8,65.8,146.8,146.8S580.9,646.9,500,646.9S353.2,581.1,353.2,500.1z M725.5,623.3   c-44.4,18-90.3,30.5-137.3,37.4c56.6-31.2,95.1-91.5,95.1-160.6s-38.5-129.4-95.1-160.6c47,6.9,93,19.4,137.3,37.4   C796,405.6,859.8,447,915,500.1C859.8,553.2,796,594.6,725.5,623.3z"
									data-original="#000000" class="active-path"
									data-old_color="#ff3a6d" fill="#ff3a6d" />
                                    <circle cx="500" cy="500.1" r="87.4"
									data-original="#000000" class="active-path"
									data-old_color="#ff3a6d" fill="#ff3a6d">
                                </g>
                            </svg>
							<h6 class="categoryName">최근 본</h6>
						</div>
					</a>
				</div>
				<div class="col-md-2 col-sm-6 col-xs-6 category-responsive">
					<span id="mypage_reserve" class="category-wrap">
						<div class="category-block">
							<svg class="category-img" id="Capa_3"
								xmlns="http://www.w3.org/2000/svg"
								xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px"
								y="0px" viewBox="-20 -30 550 550" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
                                            <path
									...
									data-original="#000000" data-old_color="#ff3a6d" fill="#ff3a6d" />
                                        </g>
                                    </g>
                                    <g>
                                        <g>
							...
							<h6 class="categoryName">예약내역</h6>
						</div>
					</span>
				</div>
				<div class="col-md-2 col-sm-6 col-xs-6 category-responsive">
					<span id="mypage_review" class="category-wrap">
						<div class="category-block">
              ...
              <g>
				...
				<div class="col-md-2 col-sm-6 col-xs-6 category-responsive">
					<span id="mypage_coupon" class="category-wrap">
						<div class="category-block">
							<svg class="category-img" xmlns="http://www.w3.org/2000/svg"
								xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
				...
				<div class="col-md-2 col-sm-6 col-xs-6 category-responsive">
					<span id="mypage_infoupdate" class="category-wrap">
						<div class="category-block">
							<svg class="category-img" xmlns="http://www.w3.org/2000/svg"
								xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
							...
							<h6 class="categoryName">내 정보 수정</h6>
						</div>
					</span>
				</div>
			</div>
