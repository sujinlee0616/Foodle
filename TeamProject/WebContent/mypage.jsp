                    ...
                    <a href="#" class="category-wrap">
                        <div class="category-block">
                            <svg class="category-img" id="Capa_1" 
                                ...
                                x="0px" y="0px" viewBox="-50 -80 600 600" 
                                xml:space="preserve">
                                <g>
                    ...
                    <a href="#" class="category-wrap">
                        <div class="category-block">
                            <svg class="category-img" id="Capa_3"
                                ...
                                x="0px" y="0px" viewBox="-20 -30 550 550" 
                                xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
